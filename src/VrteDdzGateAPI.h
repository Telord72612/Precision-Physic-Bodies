...
//  their per-region masks, the heavy-armor rule, the two device-blocks-device carve-outs
//  and DD's own zad_Permit* exceptions.
//
...
//    real record). If you pass an inventory half we log it and answer "allowed", so the
//    failure mode is your current behaviour, never a false refusal.
// ═══════════════════════════════════════════════════════════════════════════════════════
