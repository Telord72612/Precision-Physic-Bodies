...
#undef PK
    ...
    float PushStepPressEventU()      { const float v = g_tune.pushStepPressEventU; return v <= 0.f ? 0.f : (v > 50.f ? 50.f : v); }
    float PushStepPressEventGapS()   { const float v = g_tune.pushStepPressEventGapS; return v < 0.2f ? 0.2f : (v > 30.f ? 30.f : v); }
    // v16
